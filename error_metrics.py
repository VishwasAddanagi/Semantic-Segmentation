# -*- coding: utf-8 -*-
"""
Created on Tue Jun 27 19:28:15 2023
...
groundtruth_path = "C:/Users/User/Pictures/Camera Roll/cityscapes/train_mask/"
pred_path="C:/Users/User/Pictures/Camera Roll/cityscapes/predicted/"
...
#print("Mean Average Precision (MAP):",total_map/2000)
# Print the result
#rint("Mean Absolute Error (MAE):", overall_mae)
'''
for i in P:
    gd_image = cv2.imread(groundtruth_path+i)
    

    mae = calculate_MAE(segmented_mask, thresh1_img)
    total_mae+=mae
    #print("MAE:", mae)
    #map_score = calculate_average_precision(segmented_mask, thresh1_img)
